...
function animateArrowATPosition(left,top,height,degg)
{
 ...
 function magic()
 {
   ...
   if (simsubscreennum==1)
   {
    ...
    animateArrowATPosition(60,90,20,270);
...
function step1()
{
 ...
 document.getElementById("a3").style.animation = "mover 1s forwards";
 setTimeout(function()
 {
   myInt = setInterval(function(){ animatearrow(); }, 500);
   animateArrowATPosition(210,240,20,720);
 },1000);
...
function step1_11()
{
  ...
  setTimeout(function()
  {
   document.getElementById("a6").style.animation = "moven 1s forwards";
   setTimeout(function()
   {
...
function step2()
{
  ...
  document.getElementById("a12").style.animation = "moves 2s forwards";
  setTimeout(function()
  {
    ...
    setTimeout(function()
    {
      ...
      setTimeout(function()
      {
        ...
        document.getElementById("a12").style.animation = "movess 2s forwards";
        setTimeout(function()
        {
          ...
          setTimeout(function()
          {
            ...
            setTimeout(function()
            {
              ...
              document.getElementById("a12").style.animation = "movese 2s forwards";
              setTimeout(function()
              {
...
function step3()
{
  ...
  document.getElementById("a1-21").style.animation = "movehand1 1s forwards";
  setTimeout(function()
  {
    document.getElementById("a1-2").style.animation = "movep 1s forwards";
    document.getElementById("a1-21").style.animation = "movehand11 1s forwards";
    setTimeout(function()
    {
      document.getElementById('a1-21').style.visibility="hidden";
      document.getElementById("a2-2").style.animation = "sample 5s forwards";
      document.getElementById("a2-22").style.animation = "sample10 5s forwards";
      setTimeout(function()
      {
        document.getElementById('a3-2').style.visibility="visible";

        document.getElementById("a3-2").style.animation = "movehand12 1s forwards";
        document.getElementById("a3-1").style.animation = "movebox 1s forwards";
        setTimeout(function()
        {
         document.getElementById('a3-2').style.visibility="hidden";
         document.getElementById('para').innerHTML="Static Head";
         document.getElementById('para1').innerHTML="Right Limb Reading="+data1[p][0]+" cm";
         setTimeout(function()
         {
          document.getElementById('a3-1').style.visibility="hidden"; 
          ...
          setTimeout(function()
          {
           ...
           document.getElementById("a41-22").style.animation = "movehand13 1s forwards";
           document.getElementById("a4-1").style.animation = "movebox1 1s forwards";
           setTimeout(function()
           {
             document.getElementById('a41-22').style.visibility="hidden";
             document.getElementById('para2').innerHTML="Left Limb Reading="+data1[p][1]+" cm";
             ...
             setTimeout(function()
             {
               ...
               document.getElementById("a1-23").onclick=function() {
                ...
                document.getElementById("a1-23").style.animation = "movehand2 1s forwards";
                setTimeout(function()
                {
                  document.getElementById("a1-22").style.animation = "movepp 1s forwards";
                  document.getElementById("a1-23").style.animation = "movehand22 1s forwards";
                  setTimeout(function()
                  {
                    document.getElementById('a1-23').style.visibility="hidden";
                    document.getElementById("a22-2").style.animation = "sample 5s forwards";
                    document.getElementById("a22-22").style.animation = "sample10 5s forwards";
                    setTimeout(function()
                    {
                      document.getElementById('a3-22').style.visibility="visible";
                      document.getElementById("a3-22").style.animation = "movehand12 1s forwards";
                      document.getElementById("a3-11").style.animation = "movebox 1s forwards";
                      setTimeout(function()
                      {
                        document.getElementById('a3-22').style.visibility="hidden";
                        document.getElementById('paraa').innerHTML="Total Head";
                        document.getElementById('para11').innerHTML="Right Limb Reading="+data1[p][3]+" cm";
                     ...
                     setTimeout(function()
                     {
                       ...
                       setTimeout(function()
                       {
                        ...
                        document.getElementById("a4-22").style.animation = "movehand13 1s forwards";
                        document.getElementById("a4-11").style.animation = "movebox1 1s forwards";
                        setTimeout(function()
                        {
                        document.getElementById('a4-22').style.visibility="hidden";
                        document.getElementById('para22').innerHTML="Left Limb Reading="+data1[p][4]+" cm";
                        ...
                        setTimeout(function()
                        {
                        document.getElementById("a21-2").style.animation = "sample 5s forwards";
                        document.getElementById("a21-22").style.animation = "sample10 5s forwards";
                        setTimeout(function()
                        {
                        document.getElementById('a31-22').style.visibility="visible";
                        document.getElementById("a31-22").style.animation = "movehand12 1s forwards";
                        document.getElementById("a31-11").style.animation = "movebox 1s forwards";
                        setTimeout(function()
                        {								
                        document.getElementById('a31-22').style.visibility="hidden";
                        document.getElementById('para0').innerHTML="Velocity Head";
                        document.getElementById('para11-1').innerHTML="Right Limb Reading="+data1[p][6]+" cm";
                        setTimeout(function()
                        {
                        document.getElementById('a31-11').style.visibility="hidden";
                        ...
                        document.getElementById("a4-2").style.animation = "movehand13 1s forwards";
                        document.getElementById("a41-11").style.animation = "movebox1 1s forwards";
                        setTimeout(function()
                        {
                        document.getElementById('a4-2').style.visibility="hidden";
                        document.getElementById('para22-1').innerHTML="Left Limb Reading="+data1[p][7]+" cm";
...
function step4()
{
  ...
  document.getElementById('a-21').style.visibility="visible";
  document.getElementById("a-21").style.animation = "movehand011 1s forwards";
  setTimeout(function()
  {
    document.getElementById("a13-2").style.animation = "movep1 1s forwards";
    document.getElementById("a-21").style.animation = "movehand01 1s forwards";
    setTimeout(function()
    {
      document.getElementById('a-21').style.visibility="hidden";
      document.getElementById("a30-2").style.animation = "sample1 5s forwards";
      document.getElementById("a30-22").style.animation = "sample11 5s forwards";
      setTimeout(function()
      {
       document.getElementById('a51-11').style.visibility="visible";
       document.getElementById('a51-22').style.visibility="visible"; 
       document.getElementById("a51-22").style.animation = "movehand21 1s forwards";
       document.getElementById("a51-11").style.animation = "movebox2 1s forwards";
       setTimeout(function()
       {
         document.getElementById('a51-22').style.visibility="hidden";

         document.getElementById('para-1').innerHTML="Static Head";
         document.getElementById('para1-1').innerHTML="Right Limb Reading="+data2[p][0]+" cm";
         setTimeout(function()
         {
          ...
          setTimeout(function()
          {
           ...
           document.getElementById("a61-22").style.animation = "movehand23 1s forwards";
           document.getElementById("a6-11").style.animation = "movebox3 1s forwards";
           setTimeout(function()
           {
             document.getElementById('a61-22').style.visibility="hidden";
             document.getElementById('para2-1').innerHTML="Left Limb Reading="+data2[p][1]+" cm";
               ...
               setTimeout(function()
               {
                 ...
                 setTimeout(function()
                 {
                  ...
                  document.getElementById("a-23").onclick=function() {
                    ...
                    document.getElementById("a-22").style.animation = "movep2 1s forwards";
                    document.getElementById("a-23").style.animation = "movehand02 1s forwards";
                    setTimeout(function()
                    {
                      document.getElementById("a34-2").style.animation = "sample1 5s forwards";
                      document.getElementById("a34-22").style.animation = "sample11 5s forwards";
                      document.getElementById('a-23').style.visibility="hidden";
                      setTimeout(function()
                      {
                        document.getElementById('a5-22').style.visibility="visible";
                        document.getElementById("a5-22").style.animation = "movehand21 1s forwards";
                        document.getElementById("a5-11").style.animation = "movebox2 1s forwards";
                        setTimeout(function()
                        {
                         ...
                         document.getElementById('para10-1').innerHTML="Right Limb Reading="+data2[p][3]+"cm";
                         setTimeout(function()
                         {
                           document.getElementById('a5-2').style.visibility="visible";
                           document.getElementById("a5-2").style.animation = "movehand23 1s forwards";
                           document.getElementById("a51-111").style.animation = "movebox3 1s forwards";

                           setTimeout(function()
                           {
                           document.getElementById('a5-2').style.visibility="hidden";
                           document.getElementById('para20-1').innerHTML="Left Limb Reading="+data2[p][4]+" cm";
                           ...
                           document.getElementById("a35-2").style.animation = "sample 5s forwards";
                           document.getElementById("a35-22").style.animation = "sample11 5s forwards";
                           setTimeout(function()
                           {
                           document.getElementById('a6-2').style.visibility="visible";
                           document.getElementById("a6-2").style.animation = "movehand12 1s forwards";
                           document.getElementById("a61-111").style.animation = "movebox 1s forwards";
                           setTimeout(function()
                           {    
                           document.getElementById('para0-1').innerHTML="Velocity Head";
                           document.getElementById('para11-2').innerHTML="Right Limb Reading="+data2[p][6]+" cm";
                           setTimeout(function()
                           {
                           ...
                           setTimeout(function()
                           {
                           document.getElementById('a6-21').style.visibility="visible";
                           document.getElementById("a6-21").style.animation = "movehand13 1s forwards";
                           document.getElementById("a6-12").style.animation = "movebox1 1s forwards";
                           setTimeout(function()
                           {
                           document.getElementById('a6-21').style.visibility="hidden";
                           document.getElementById('para22-2').innerHTML="Left Limb Reading="+data2[p][7]+" cm";
 ...
 */    },6000);
  ...
  function stepp2()
  {
    ...
    document.getElementById("b12").style.animation = "moves 2s forwards";
    setTimeout(function()
    {
      ...
      setTimeout(function()
      {
        ...
        setTimeout(function()
        {
          ...
          document.getElementById("b12").style.animation = "movess 2s forwards";
          setTimeout(function()
          {
            ...
            setTimeout(function()
            {
              ...
              setTimeout(function()
              {
                ...
                document.getElementById("b12").style.animation = "movese 2s forwards";
                setTimeout(function()
                {
					  ...
					  setTimeout(function()
                {
                  ...
                  document.getElementById('b15').style.visibility="hidden";
					validateAnswer(1, 2, "150px", "150px");
				  },800);
                  },800);
                },2000);
              },2000);
  ...
  function step33()
{
  ...
  document.getElementById("b1-21").style.animation = "movehand1 1s forwards";
  setTimeout(function()
  {
    document.getElementById("b1-2").style.animation = "movep 1s forwards";
    document.getElementById("b1-21").style.animation = "movehand11 1s forwards";
    setTimeout(function()
    {
      document.getElementById('b1-21').style.visibility="hidden";
      document.getElementById("b2-2").style.animation = "sample12 5s forwards";
      document.getElementById("b2-22").style.animation = "sample2 5s forwards";
      setTimeout(function()
      {
        document.getElementById('b3-2').style.visibility="visible";

        document.getElementById("b3-2").style.animation = "movehand24 1s forwards";
        document.getElementById("b3-1").style.animation = "movebox4 1s forwards";
        setTimeout(function()
        {
         document.getElementById('b3-2').style.visibility="hidden";
         document.getElementById('par').innerHTML="Static Head";
         document.getElementById('par1').innerHTML="Right Limb Reading="+data3[p][0]+" cm";
         setTimeout(function()
         {
          document.getElementById('b3-1').style.visibility="hidden"; 
          ...
          setTimeout(function()
          {
           ...
           document.getElementById("b41-22").style.animation = "movehand23 1s forwards";
           document.getElementById("b4-1").style.animation = "movebox3 1s forwards";
           setTimeout(function()
           {
             document.getElementById('b41-22').style.visibility="hidden";
             document.getElementById('par2').innerHTML="Left Limb Reading="+data3[p][1]+" cm";
             ...
             setTimeout(function()
             {
               ...
               document.getElementById("b1-23").onclick=function() {
                ...
                document.getElementById("b1-23").style.animation = "movehand2 1s forwards";
                setTimeout(function()
                {
                  document.getElementById("b1-22").style.animation = "movepp 1s forwards";
                  document.getElementById("b1-23").style.animation = "movehand22 1s forwards";
                  setTimeout(function()
                  {
                    document.getElementById('b1-23').style.visibility="hidden";
                    document.getElementById("b22-2").style.animation = "sample1 5s forwards";
                    document.getElementById("b22-22").style.animation = "sample13 5s forwards";
                    setTimeout(function()
                    {
                      document.getElementById('b3-22').style.visibility="visible";
                      document.getElementById("b3-22").style.animation = "movehand12 1s forwards";
                      document.getElementById("b3-11").style.animation = "movebox 1s forwards";
                      setTimeout(function()
                      {
                        document.getElementById('b3-22').style.visibility="hidden";
                        document.getElementById('parr').innerHTML="Total Head";
                        document.getElementById('par11').innerHTML="Right Limb Reading="+data3[p][3]+" cm";
                     setTimeout(function()
                     {
                       ...
                       setTimeout(function()
                       {
                        ...
                        document.getElementById("b4-22").style.animation = "movehand13 1s forwards";
                        document.getElementById("b4-11").style.animation = "movebox1 1s forwards";
                        setTimeout(function()
                        {
                        document.getElementById('b4-22').style.visibility="hidden";
                        document.getElementById('par22').innerHTML="Left Limb Reading="+data3[p][4]+" cm";
                        ...
                        setTimeout(function()
                        {
                        document.getElementById("b21-2").style.animation = "sample 5s forwards";
                        document.getElementById("b21-22").style.animation = "sample13 5s forwards";
                        setTimeout(function()
                        {
                        document.getElementById('b31-22').style.visibility="visible";
                        document.getElementById("b31-22").style.animation = "movehand12 1s forwards";
                        document.getElementById("b31-11").style.animation = "movebox 1s forwards";
                        setTimeout(function()
                        {								
                        document.getElementById('b31-22').style.visibility="hidden";
                        document.getElementById('par0').innerHTML="Velocity Head";
                        document.getElementById('par12-2').innerHTML="Right Limb Reading="+data3[p][6]+" cm";
                        //document.getElementById('para22-1').innerHTML="Left Limb Reading=19.3 cm";
                        //document.getElementById('para33-1').innerHTML="Diffrence=0.9cm";
                        setTimeout(function()
                        {
                        document.getElementById('b31-11').style.visibility="hidden";
                        ...
                        document.getElementById("b4-2").style.animation = "movehand13 1s forwards";
                        document.getElementById("b41-11").style.animation = "movebox1 1s forwards";
                        setTimeout(function()
                        {
                        document.getElementById('b4-2').style.visibility="hidden";
                        document.getElementById('par22-2').innerHTML="Left Limb Reading="+data3[p][7]+" cm";
